...
class StockitemsControllerTest < ActionController::TestCase
  ...
  test "should create stockitem" do
    assert_difference('Stockitem.count') do
      post :create, stockitem: { details_hint_de: @stockitem.details_hint_de, details_hint_en: @stockitem.details_hint_en, title: @stockitem.title_de }
    end
  ...
  test "should update stockitem" do
    patch :update, id: @stockitem, stockitem: { details_hint_de: @stockitem.details_hint_de, details_hint_en: @stockitem.details_hint_en, title: @stockitem.title_de }
    assert_redirected_to stockitem_path(assigns(:stockitem))
  end
