...
class StockitemsControllerTest < ActionController::TestCase
  ...
  test "should create stockitem" do
    assert_difference('Stockitem.count') do
      post :create, stockitem: { details_hint: @stockitem.details_hint, picture: @stockitem.picture, rate_eur: @stockitem.rate_eur, rate_interval: @stockitem.rate_interval, title: @stockitem.title }
    end
  ...
  test "should update stockitem" do
    patch :update, id: @stockitem, stockitem: { details_hint: @stockitem.details_hint, picture: @stockitem.picture, rate_eur: @stockitem.rate_eur, rate_interval: @stockitem.rate_interval, title: @stockitem.title }
    assert_redirected_to stockitem_path(assigns(:stockitem))
  end
