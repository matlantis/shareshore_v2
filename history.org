...
#+TAGS: bug feature enhance text layout concept
...
*** TODO admin mode für stockitems und houses                       :feature:
*** TODO mehr stockitems                                               :text:
*** TODO wie-bin-ich-abgesichert-seite                                 :text:
    in FAQ
*** TODO site ohne js testen                                            :bug:
*** TODO Devise with email confirmation                             :feature:
...
*** TODO stockitems: new article muss zugänglicher sein             :enhance:
