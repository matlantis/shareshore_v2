...
* Shareshore V2 Todos
** Primär
*** TODO Too many places for article fields:
...
*** TODO diese bootstrap-rails formulare sind alle etwas fragwürdig
    zu wenig und unklare gestaltungsmglkeiten
    kann man da nicht was machen?

*** TODO wie kann man manage articles and new articles zusammenfassen?
*** TODO hilfe bereich fertig stellen [1/3]
    - [X] struktur
    - [ ] texte
    - [ ] einzel layout
*** TODO klären was dieses respond_to eigentlich tut
    klingt nach ajax oder irgend wie zu aufwendigen methoden, ersetzen durch nen simpleren aufruf
*** TODO wie geht redirect to last location on that page?
    http://zogovic.com/post/19629950359/preserving-scroll-position-across-pages
    seems to be haml syntax? nope, its coffeescript
*** TODO Artikel erstellen/bearbeiten als Overlay
