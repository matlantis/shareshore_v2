...
*** TODO contact zu nutzern via formular: absender nick as betreff streichen
    das wird sonst komisch, wenn man reply macht und den andere (Paul) liest dann "Re: Nachricht von Paul" 
*** TODO anfragen für article reply-to adresse
    geht momentan an mail@shareship.de
*** TODO seite contacts: send gibt keine rückmeldung                    :bug:
*** TODO schicker cookie hinweis                                     :layout:
    http://veganer-kuchen.net/
*** TODO mobile ansicht                                              :layout:
...
*** TODO abschnitt über diebstahl in faq ergänzen                      :text:
*** TODO profil ansicht
    listet nur locations, könnte aber auch artikel listen wie search
*** TODO email verification after change behaves like new registration
*** TODO location country choice box
*** TODO howtos brauchen icons                                  :enhancement:
*** TODO purify                                                         :bug:
...
*** DONE formular gestaltung (such formular)
    ...
    howto checkbox brauchen nen tooltip
...
*** DONE use pattern field als filter (if it was empty before)
    ...
    easy
*** DONE radius durch bewegungsmittel (howto) ersetzen
    CLOSED: [2017-01-28 Sa 14:16]
