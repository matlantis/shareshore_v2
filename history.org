...
*** TODO article index: show own articles als checkbox
    oder hinweis, dass die eigenen artikel incht angezeigt werden
*** TODO details feld mit ... versehen
...
*** TODO artikel und location index: wenn map nicht angezeigt wird, stimmt das grid layout nicht mehr
*** TODO profil ansicht: artikel bei location nur anzeigen, wenn nutzer mehrere locations hat
*** TODO tooltips
*** TODO link layout der edit und remove buttons
*** TODO neue sitemap entwerfen
*** TODO hilfe bereich im artikel index
    achtung: verschiedene ansichten, als nutzer-liste, als owner-liste
*** TODO gratis noch besser hervorheben
*** TODO für die beta-phase: nur angemeldete user kriegen kontaktinfos und nutzerprofile angezeigt
*** TODO hilfe bereich fertig stellen [1/3]
    - [X] struktur
    - [ ] texte
    - [ ] einzel layout
*** TODO Artikelsuche ergebnis liste überarbeiten [2/3]
...
*** WAITING karte aufhübschen [2/5]
    - [ ] nur locations einzeichnen, nicht artikel
