...
* Shareshore V2 Todos
** Primär
*** TODO contact details check boxes in article_request_mail form :enhancement:
*** TODO map pattern kriterium                                          :bug:
    map in search zeigt alle locations nicht nur solche mit pattern kriterium
*** TODO user alert if no location exists on article creation           :bug:
*** TODO suche als get mit parametern statt als post            :enhancement:
    besseres reload und zurück verhalten
*** TODO reference to deleted location                                  :bug:
...
*** TODO polls                                                      :feature:
*** TODO dem nutzer eine mail schreiben                             :feature:
