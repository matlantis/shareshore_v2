...
* Shareshore V2 Todos
** Primär
*** TODO in devise emails wird der nutzen mit seiner email statt nickname angesprochen
*** TODO translation missing: de.devise.sessions.user.already_signed_out
*** TODO user messaging and contact
...
***** message attributes
      ...
      contact mglkeiten
      betreff? nöö
*** TODO email signatur unter alle emails                       :enhancement:
*** TODO js code wird in article/standorte nicht korrekt ausgefúhrt     :bug:
...
*** TODO pinning the map using bootstrap affix                       :layout:
*** TODO purify                                                         :bug:
