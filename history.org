...
*** TODO gratis option beim artikel erstellen
*** TODO hilfe bereich realisieren
...
*** TODO new articles layout [1/2]
    - [X] die room panels sind zu groß
    - [ ] der erstellen button ist nicht sichtbar genug
    - [ ] die eingabe felder sind zu fett
    - [ ] die räume haben ne hässliche farbe
