...
* Shareshore V2 Todos
** Primär
*** TODO das search form schaut beschissen aus, wenn display zu klein   :bug:
*** TODO ersetze tafel schokolade durch ein eis
    besser als icon darzustellen
    
*** TODO search: wenn adresse unbekannt, kommt einfach nix              :bug:
