...
* Shareshore V2 Todos
** Primär
*** TODO remove the unneeded json respond_to statements                :code:
...
*** TODO registrier mail mit text alternative                           :bug:
*** TODO invisible captcha                                      :enhancement:
...
*** TODO pinning the map using bootstrap affix
...
*** TODO send request without js: reade guidline message missing :enhancement:
