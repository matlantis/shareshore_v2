...
* Shareshore V2 Todos
** Primär
*** TODO beta warning ausblenden (wie cookie)
*** TODO layout inventar ist unübersichtlich
*** TODO standort erstellen direkt nach dem login - wegweiser
*** TODO anfrage senden passiert nix
    vmtl weil email grad buggy ist, testen wenn das richtig läuft
    da sollte das error modal aufploppen
*** TODO jesko bug anzahl artikel unter vorlagen                        :bug:
...
*** TODO contributions page                                            :text:
    mit lizenz stuff
*** TODO richtlinie: vereinbart ausdrücklich eine gegenleistung!
    
*** TODO leihgebühr umorganisieren                                  :concept:
    umbenennen
    - gegenleistung
    - im austausch
    - tarif
...
**** implementation [6/8]
    - [ ] datenbank: gratis checkbox entfällt - unwichtig
    ...
    - [ ] article_form: bildchen on selection
*** TODO standort ansicht und liste mit articlen an standort mergen
*** TODO in profile edit has checkbox for show name, but its not shown nowhere
*** TODO contact dont show checkboxes for phone or name if not given
*** TODO admin create stockitem in article/show only if not associated with a stockitem
