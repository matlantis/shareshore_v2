...
* Shareshore V2 Todos
** Primär
*** TODO map in profile page mobile covers lowest content               :bug:
*** TODO rework mobile design                                           :bug:
*** TODO content review email braucht reject link                   :feature:
*** TODO location als einfaches textfeld                            :feature:
...
*** TODO Profilpage edit Buttons                                :enhancement:
*** TODO code clean up                                                 :code:
there is a bunch of old code in the code
*** TODO warning appeared when pushing to heroku                       :code:
