...
* Shareshore V2 Todos
** Primär
*** TODO try forms without remote and enable turbolinks                :code:
...
*** TODO requests contact method                                    :feature:
    ...
    für den fehlerfall das formular durch ein generiertes ersetzen (ähnlich wie articles und locations)
...
*** TODO move more javascript into assets                              :code:
    ...
    die maps ham nochn bissl js code
