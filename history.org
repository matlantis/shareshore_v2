...
* Shareshore V2 Todos
** Primär
*** TODO artikel hervorheben, wenn Sie im eigenen haus sind
*** TODO current_location marker überarbeiten
*** TODO an einem Haus überdeckt der current_location marker den Haus marker
    irgendwie zusammenführen
*** TODO falls ergebnis liste leer, entsprechenden text anzeigen
    vorkommen:
*** TODO löse das problem falsch aufgelöster locations
    nutzer markieren ihr haus manuell
*** TODO session[address] bei login mit erster location füllen
*** TODO wie ist die identität der nutzer geschützt?
    für die beta-phase: nur angemeldete user kriegen kontaktinfos und nutzerprofile angezeigt    
*** TODO site ohne flash testen
*** TODO tooltips
*** TODO hilfe bereich im artikel index fehlt
