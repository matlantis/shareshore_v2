...
*** TODO artikel im kartenaussschnitt [2/3]                         :feature:
    ...
    - [ ] get rid of radius (use default)
    - [ ] find articles in a box not a circle
    - [ ] load the results after map is displayed 
    - [ ] don't scroll map if at top or bottom                   :enhancement:

*** TODO search results: haus info: und Du                              :bug:
