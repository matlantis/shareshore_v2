...
#+TAGS: bug feature enhancement text layout concept code theme
...
*** DONE use pattern field als filter (if it was empty before)
    ...
    easy
*** TODO radius durch bewegungsmittel (howto) ersetzen
*** TODO description etwas einrücken
*** TODO leaflet and turbolinks zusammen erzeugen fehlermeldungen       :bug:
*** TODO entfernung in geh minuten                                  :feature:
    oder je nach dauer mit fahrrad oder auto
    einfach easy as der luftlinie kalkulieren
    1km luftline ~ 1.5 km zickzack ~ 20min zu Fuß 
    5km luftlinie ~ 7.5 km zickzack ~ 30min mit Fahrrad
    20km
*** TODO artikel im kartenaussschnitt [6/10]                        :feature:
...
*** TODO den blödsinn mit den kontaktdaten einfach rausschmeißen!
    nutzer sollen ihre kontaktdaten selber in die message schreiben
*** TODO user messaging and contact                                   :theme:
**** TODO request nachrichten vereinfachen (inhaltlich)
...
**** TODO requests contact method                                   :feature:
     antwort mglkeit
...
**** TODO user messages verschicken
**** DONE user messages empfangen
     CLOSED: [2017-01-24 Di 20:54]
