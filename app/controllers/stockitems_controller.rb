class StockitemsController < ApplicationController
  ...
  def index
    ...
    #   a = Article.new(title: t["title_" + I18n.locale.to_s] , details: t["details_hint_" + I18n.locale.to_s], stockitem_id: t.id, quality: 3)
    #   @articles.push(a)
    # end
  end
  # GET /stockitems/1
  ...
  private
    ...
    def stockitem_params
      params.require(:stockitem).permit(:title_de, :title_en, :details_hint_de, :details_hint_en, :category_id)
    end
end
